    ...
    Finances: [
      {
        ...
        answer:
          'Virufy is currently only collecting coughs from certain countries, which can be found in our app: https://virufy.org/app',
      },
      {
      ...
      },
      {
        ...
        answer:
          'We have more than 5,000 cough recordings from over 10 countries, mostly in South America and South Asia. Some of these are clinical, and others are contributed directly by individuals in our app.',
      },
      {
        question: 'What are the operational expenses for the organization?',
        answer:
          'We are currently completely volunteer run. Our main budget requirements are for marketing to complete data collection. We would also need money for computation later on after scaling to a large user base.',
      },
      {
        question:
          'Does the team get funding? If so, where and how much? What is it used on?',
        answer:
          'We do not have funding yet, as we are just starting to apply for grants after recently obtaining 501(c)(3) status.',
      },
    ],
    Privacy: [
      {
    ...
    Other: [
      {
        ...
        answer:
          'You can join our team today and look at the join page for more information. You can also support us at GoFundMe. You can also contact us for partnership.',
      },
      {
        question:
          'How does distribution work, and how will Virufy become more widespread?',
        answer:
          'The app will be offered for the benefit of people in low-income countries and will likely market itself and spread quickly',
      },
      {
