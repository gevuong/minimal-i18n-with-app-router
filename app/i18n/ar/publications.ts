...
const publications: Publications = {
  publicationsSection: {
    title: 'المنشورات',
    texts: [
      'فيما يلي العديد من أوراقنا التي تعرض التطور والعلم وراء قوة فيروفي.',
    ],
  },
  publicationsCards: [
    {
    ...
    {
      title:
        'فيروفي: إمكانية تطبيق عالمي لمجموعات البيانات المجمعة والسريرية للكشف عن COVID-19 باستخدام الذكاء الاصطناعي من السعال',
      date: 'نوفمبر 2020',
