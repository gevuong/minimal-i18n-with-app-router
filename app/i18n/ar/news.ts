...
const pressReleases: PressReleases = {
  ...
  pressReleaseCards: [
    ...
    {
      title:
        'هذا التطبيق يسعى لتشخيص COVID-19 بمجرد السعال أمام الهاتف',
      date: 'فبراير 2021',
    ...
    {
      title:
        'COVID-19: تطبيق Virufy يمكنه تشخيص الفيروس من خلال تحليل السعال',
      date: 'يناير 2021',
      subtext: 'MSN',
    ...
    {
      title: 'سفير One Young World في اليابان يستهدف COVID-19 باستخدام الذكاء الاصطناعي',
      date: 'مايو 2020',
