...
const footer: Footer = {
  sectionPersonalInformation: [
    {
      title: 'Derechos de la Ley de Privacidad del Consumidor de California',
      content:
    ...
    {
      title: 'Cómo ejercer estos derechos?',
      content:
    ...
    {
      title: 'Marketing directo y no seguimiento',
      content:
