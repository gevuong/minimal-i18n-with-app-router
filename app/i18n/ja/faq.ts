...
const faq: FAQ = {
  ...
  questionsByTopic: {
    Virufyアプリ: [
      {
        ...
        answer:[
          {
            type: 'text',
            text: '当ア   プリは現在、データ収集のみの目的で使用されています。各国の公衆衛生当局の承認や、AI技術の臨床的検証が完了するまではCOVID-19予測アプリをリリースすることはできません。このプロセスは、各政府の対応の迅速さに応じて数週間から数か月かかる場合があります。Virufyは、この技術を人々に無償で提供し、高価なPCR検査の使用を必要な場合に最適化するため、保健当局や病院とのパートナーシップを歓迎します。',
          }   
        ]
      },
      {
    ...
    Virufyについて: [
      ...
      {
        question: 'Virufyプロジェクトの実現のためにどのくらいの投資が行われましたか？',
        answer:[
          { 
            type: 'text',
    ...
    その他: [
      {
        ...
        answer:[
          ...
          {
            type: 'text',
            text: 'で詳細を確認し、私たちのチームに参加することが可能です。また、GoFundMeでの支援も可能です。パートナーシップについてのお問い合わせも受け付けています。',
          },
        ]
      },
      {
