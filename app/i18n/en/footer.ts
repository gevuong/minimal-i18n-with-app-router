        ...
        answer: [
          ...
          },
          {
            ...
            content: [
              ...
              {
                type: 'text',
                text: ': These cookies are used to track visitors across websites. The intention is to display ads that are relevant and engaging for the individual user and thereby more valuable for publishers and third-party advertisers. These cookies can be deleted or blocked by adjusting your browser settings (see "How can you control Cookies" below). Alternatively, please follow the link here to ',
              },
              {
                type: 'link',
